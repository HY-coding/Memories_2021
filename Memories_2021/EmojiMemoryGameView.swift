...
struct CardView: View {
    ...
    @State private var animatedBousRemaining: Double = 0
            ...
            ZStack {
                ...
                Group {
                    ...
                    if card.isConsumingBonusTime {
                        Pie(startAngle: Angle(degrees: 0 - 90), endAngle: Angle(degrees: (1 - animatedBousRemaining)*360 - 90))
                            .onAppear{
                                animatedBousRemaining = card.bonusRemaining
                                withAnimation(.linear(duration: card.bonusTimeRemaining)) {
                                    animatedBousRemaining = 0
                                }
                            }
                    } else {
